...
- **executeCommand** captures **stdout** and **stderr** separately as streamed chunks, then a final **exit** chunk. **Do not** append \`2>&1\`, \`2>&1 |\`, or other shell redirects to merge stderr — that is unnecessary and hides which stream is which.

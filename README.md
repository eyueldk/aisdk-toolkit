...
| [@eyueldk/aisdk-toolkit-filesystem](packages/filesystem) | 1.4.0 | `readFile` / … / composite **mounts** |
| [@eyueldk/aisdk-toolkit-shell](packages/shell) | 1.3.1 | `executeCommand` (agent **`cwd`**) |
